...
public class SearchBoardController {
	...
	private static final Logger logger = LoggerFactory.
			getLogger(SearchBoardController.class);
	...
	public String removePaging(@RequestParam("bno") int bno, @ModelAttribute("cri") SearchCriteria cri, RedirectAttributes rttr) throws Exception{
		service.remove(bno);
